...
This script runs the Nelder-Mead implementation on the benchmark suite
...
def main():
    ...
    print("="*60)
    print("BASELINE BENCHMARK: Nelder-Mead Implementation")
    print("="*60)
    print("\nTask 12.1: Run implementation on benchmark suite")
    ...
    # Save results
    output_file = 'baseline_results_nm.json'
    ...
    # Save results
    output_file = 'baseline_results_anm.json'
    with open(output_file, 'w') as f:
